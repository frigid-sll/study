...
docker教程：<http://www.ruanyifeng.com/blog/2018/02/docker-tutorial.html> 
...
> - `FROM node:8.0`：该 image 文件继承官方的 node image，冒号表示标签，这里标签是`8.0`，即8.0版本的 node。
